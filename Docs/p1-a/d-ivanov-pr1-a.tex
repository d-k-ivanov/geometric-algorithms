...
\begin{itemize}
    ...
    \begin{minted}[fontsize=\scriptsize,mathescape,linenos,frame=single,xleftmargin=20pt,xrightmargin=20pt,numbersep=0.2em]{Batch}
    ...
    \begin{minted}[fontsize=\scriptsize,mathescape,linenos,frame=single,xleftmargin=20pt,xrightmargin=20pt,numbersep=0.2em]{Powershell}
...
\begin{itemize}
    ...
    \begin{minted}[fontsize=\scriptsize,mathescape,linenos,frame=single,xleftmargin=20pt,xrightmargin=20pt,numbersep=0.2em]{Bash}
