...
public:
    struct MatrixRenderInformation
    {
        ...
        mat4 multiplyMatrix(MatrixType tMatrix, const mat4& matrix)
        {
        ...
        void setMatrix(MatrixType tMatrix, const mat4& matrix)
        {
            this->saveMatrix(tMatrix);
...
public:
    ...
    Model3D*     setModelMatrix(const mat4& modelMatrix)
    {
